...
class WifiUtil {
    ...
    private IScanResultsListener scanResultsListener;
    ...
    WifiUtil(Context context) {
        ...
        this.logger = Logger.createLogger(WifiUtil.class);
    ...
    void setWifiScanResultsListener(final IScanResultsListener scanResultsListener) {
    ...
    void removeWifiScanResultsListener(@NonNull IScanResultsListener listener) {
